...
public class OracleSyntaxChecker implements SqlGenerator {
    ...
    private final boolean enable = Boolean.getBoolean("liquibase.ext.OracleSyntaxChecker.enable");
    ...
    public ValidationErrors validate(SqlStatement sqlStatement, Database database, SqlGeneratorChain sqlGeneratorChain) {
        ...
        LOGGER.info("Validating SqlStatement for Oracle target : " + sqlStatement.getClass().getSimpleName());
        // validate
